...
echo "Running annotation-regional-refined-br-spore"
time /gpfs/mskmindhdp_emc/sw/env/bin/python3 -m data_processing.pathology.refined_table.regional_annotation.dask_generate -d /gpfs/mskmindhdp_emc/etl-runner/configs/BR_20-226/dask_regional_annotation_config_br.yaml -a /gpfs/mskmindhdp_emc/etl-runner/configs/config.yaml
...
echo "Running annotation-point-proxy-br-spore ETL"
time /gpfs/mskmindhdp_emc/sw/env/bin/python3 -m data_processing.pathology.point_annotation.proxy_table.generate -d /gpfs/mskmindhdp_emc/etl-runner/configs/BR_20-226/point_js_br.yaml -a /gpfs/mskmindhdp_emc/etl-runner/configs/config.yaml
...
echo "Running annotation-point-refined-br-spore ETL"
/gpfs/mskmindhdp_emc/sw/env/bin/python3 -m data_processing.pathology.point_annotation.refined_table.generate -d /gpfs/mskmindhdp_emc/etl-runner/configs/BR_20-226/point_geojson_br.yaml -a /gpfs/mskmindhdp_emc/etl-runner/configs/config.yaml
