...
@click.option(
    "-i",
    "--input",
    help="path to stardist geojson classification results",
    required=False,
...
@click.option(
    "-i",
    "--input",
    help="path to TSV classification data generated by stardist",
    required=False,
    type=click.Path(exists=True),
)
@click.option(
...
@click.option(
    "-i",
    "--input",
    help="path to regional annotation geojson",
    required=False,
    type=click.Path(exists=True),
)
@click.option(
...
@click.option(
    "-i", "--input", help="map of {label:path_to_bitmask_png}", required=False
)
@click.option(
    "-o",
    "--output_dir",
...
@click.option(
    "-i",
    "--input",
    help="path to CSV with tile scores",
    required=False,
    type=click.Path(exists=True),
)
@click.option(
