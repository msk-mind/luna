...
def test_singleton(cfg):
    ...
    c3 = ConfigSet(name='app_config', config_file='tests/luna/common/another_test_config.yml')
    c4 = ConfigSet(name='app_config', config_file='tests/luna/common/another_test_config.yml')
...
def test_singleton_with_schema(cfg):
    schema_file = get_absolute_path(__file__, '../../../luna/data_ingestion_template_schema.yml')

    c1 = ConfigSet(name='app_config', config_file='tests/luna/common/test_config.yml')
    c2 = ConfigSet(name='data_config', config_file='tests/luna/common/test_data_ingestion_template.yml',
...
def test_clear(cfg):
    ...
    ConfigSet(name='data_config', config_file='tests/luna/common/test_data_ingestion_template.yml',
                   schema_file=schema_file)
    c1 = ConfigSet()
    assert c1.get_names() == ['app_config', 'data_config']
    c1.clear()
