...
scores_csv_path = "tests/luna/pathology/common/testdata/input/tile_scores_and_labels.csv"
...
def test_pretile_scoring(requests_mock):
    ...
    params = {"tile_size":128,
              ...
              "annotation_table_path": "tests/luna/pathology/common/testdata/project/tables/REGIONAL_METADATA_RESULTS"
              }
    res = pretile_scoring(slide_path, output_dir,
                          "tests/luna/pathology/common/testdata/project/tables/REGIONAL_METADATA_RESULTS",
                          params, "123")

    print(res)
    assert 'tests/luna/pathology/common/testdata/output-123/tiles.slice.pil' == res['data']
    assert 'tests/luna/pathology/common/testdata/output-123/address.slice.csv' == res['aux']
...
def test_run_model():
    ...
    res = run_model('/gpfs/mskmindhdp_emc/data/TCGA-BRCA/TCGA-D8-A4Z1-01Z-00-DX1.D39D38B5-FC9F-4298-8720-016407DC6591/test_collect_tiles/tiles.slice.pil',
                    ...
                    'tests/luna/pathology/common/testdata', params)
