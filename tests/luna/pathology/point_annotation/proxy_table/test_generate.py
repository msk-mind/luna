...
from luna.pathology.point_annotation.proxy_table.generate import create_proxy_table, download_point_annotation, cli

project_path = "tests/luna/pathology/point_annotation/testdata/test-project"
...
def setup_module(module):
    ...
    cfg = ConfigSet(name=const.DATA_CFG,
              config_file='tests/luna/pathology/point_annotation/testdata/point_js_config.yaml')
