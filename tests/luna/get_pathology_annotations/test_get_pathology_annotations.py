...
def client():
    ...
    cfg = ConfigSet(name=APP_CFG, config_file='tests/luna/get_pathology_annotations/test_get_pathology_annotations_config.yaml')
...
def test_get_regional_annotation(mocker, client, monkeypatch):
    ...
    def mock_datastore_get(*args, **kwargs):
        if kwargs['store_id'] == '123456':
            return 'tests/luna/pathology/common/testdata/project/slides/123/CONCAT/RegionalAnnotationJSON/DEFAULT'
        else:
