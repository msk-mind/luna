...
def test_transfer_files_1(env):
    ...
    #
    os.environ['CHUNK_FILE'] = 'tests/luna/radiology/proxy_table/test_data/chunk_file1.txt'
    os.environ['SOURCE_PATH'] = os.getcwd() + \
                                '/tests/luna/radiology/proxy_table/test_data/source/'
...
def test_transfer_files_2(env):
    ...
    #
    os.environ['CHUNK_FILE'] = 'tests/luna/radiology/proxy_table/test_data/chunk_file2.txt'
    os.environ['SOURCE_PATH'] = os.getcwd() + \
                                '/tests/luna/radiology/proxy_table/test_data'
