...
dicom_path = f"{data_dir}/radiology/2.000000-CTAC-24716/dicoms/1-01.dcm"
image_path = f"{data_dir}/radiology/2.000000-CTAC-24716/volumes/image.mhd"
label_path = f"{data_dir}/radiology/2.000000-CTAC-24716/volumes/label.mha"
...
def test_subset_bound_seg():
    ...
    os.remove(f"{data_dir}/radiology/2.000000-CTAC-24716/volumes/subset_image.raw")
