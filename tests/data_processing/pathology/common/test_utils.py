...
from data_processing.pathology.common.utils import get_labelset_keys, convert_xml_to_mask, convert_halo_xml_to_roi
import numpy as np
...
xml_data_path = 'tests/data_processing/pathology/testdata/data/test-project/pathology_annotations/123456_annotation_from_halo.xml'
