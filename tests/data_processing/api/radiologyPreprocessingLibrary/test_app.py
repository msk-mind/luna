...
from data_processing.api.radiologyPreprocessingLibrary import app
...
def test_app_post(client, monkeypatch):
    ...
    data = {"paths": ["tests/data_processing/api/radiologyPreprocessingLibrary/testdata/1.dcm",
                      "tests/data_processing/api/radiologyPreprocessingLibrary/testdata/2.dcm"],
            "width": 512,
            "height": 512}
...
def test_app_post_bad_input(client):
    ...
    data = {"dicom_paths": ["tests/data_processing/api/radiologyPreprocessingLibrary/testdata/1.dcm",
                      "tests/data_processing/api/radiologyPreprocessingLibrary/testdata/2.dcm"],
            "width": 512}
...
def test_app_get(client, monkeypatch):
    ...
    data = {"output_location": "data_processing/api/tests/api/test.parquet"}
