...
if __name__ == "__main__":
    c1 = ConfigSet("app_config", "tests/luna/common/test_config.yml")
    c2 = ConfigSet("app_config", "tests/luna/common/test_config.yml")
    c3 = ConfigSet("app_config", "tests/luna/common/test_config.yml")
    ...
    print(
        ...
        + str(
            c1.get_value(
                'app_config::$.spark_application_config[:1]["spark.executor.cores"]'
            )
        )
    )
    print(
    ...
    try:
        print(
            ...
            + str(
                c3.get_value(
                    'app_config::$.spark_application_config[:1]["doesnt_exist"]'
                )
            )
        )
